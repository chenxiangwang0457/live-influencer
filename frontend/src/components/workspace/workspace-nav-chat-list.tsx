...
import { BotIcon, CalendarClock, MessagesSquare, UserCheck } from "lucide-react";
  ...
  return (
    <SidebarGroup className="pt-1">
      <SidebarMenu>
        ...
        <SidebarMenuItem>
          <SidebarMenuButton
            isActive={pathname.startsWith("/workspace/influencer")}
            asChild
          >
            <Link
              className="text-muted-foreground"
            ...
            >
              <UserCheck />
              <span>{t.sidebar.influencers}</span>
            </Link>
          </SidebarMenuButton>
        </SidebarMenuItem>
      </SidebarMenu>
